...
import com.group20.vetclinic.security.JwtAuthFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/boarding/vet/**").hasRole("VET")
                .requestMatchers("/api/boarding/rooms/available").hasAnyRole("OWNER", "CLINIC_MANAGER", "ADMIN")
                .requestMatchers(HttpMethod.GET,  "/api/boarding/reservations/*/feeding-logs").hasAnyRole("VET", "CLINIC_MANAGER", "ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/boarding/reservations/*/feeding-logs").hasAnyRole("VET", "CLINIC_MANAGER", "ADMIN")
                ...
                .requestMatchers(HttpMethod.POST,   "/api/inventory/waste").hasAnyRole("CLINIC_MANAGER", "VET")
